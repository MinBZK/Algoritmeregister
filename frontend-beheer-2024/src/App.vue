...
import AlgregSnackbar from '@/components/AlgregSnackbar.vue'
import TemplateDrawer from '@/components/layout/TemplateDrawer.vue'
import VersionDrawer from './components/archive/VersionDrawer.vue'
