    ...
    <div class="container row header-width">
      <div class="header-spacing">
        <DownloadDropdown
          ...
          :action="{
            currentPublished: algoritmeService.downloadOneUrl(
              algoritme?.lars || '',
              mapLocaleName(locale as 'en' | 'nl')
            ),
            allPublished: algoritmeService.downloadAllPublishedVersionsOneUrl(
              algoritme?.lars || '',
              mapLocaleName(locale as 'en' | 'nl')
            ),
          }"
...
const lars = params.at(params.length - 2)!
